...
{
	public static CantTalon newCantTalon(int deviceNumber)
	{
		CantTalon temp = new CantTalon(deviceNumber);
	...
	CANTalon talon;
	private CantTalon(int deviceNumber) 
	{
	...
	private static ArrayList<CantTalon> instances = new ArrayList<CantTalon>();
